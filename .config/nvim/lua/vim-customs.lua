...
-- Easy for recize the nvim panes
vim.keymap.set("n", "<M-H>", ':wincmd h<CR>', { noremap = true, silent = true, desc = "Move pane to left (h)" })
vim.keymap.set("n", "<M-J>", ':wincmd j<CR>', { noremap = true, silent = true, desc = "Move pane to down (j)" })
vim.keymap.set("n", "<M-K>", ':wincmd k<CR>', { noremap = true, silent = true, desc = "Move pane to up (k)" })
vim.keymap.set("n", "<M-L>", ':wincmd l<CR>', { noremap = true, silent = true, desc = "Move pane to right (l)" })
